    ...
    <article className="mx-auto max-w-3xl space-y-8">
      <header>
        ...
        <p className="mt-3 text-sm text-brand-muted">
          By [YOUR_NAME] · {new Date(post.date).toLocaleDateString()} · {post.readTime}
        </p>
      </header>
      ...
      <div className="flex gap-3">
        ...
        <Link
          href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent('https://example-portfolio.netlify.app/blog/' + post.slug)}`}
          className="rounded-full border border-brand-border px-4 py-2 text-sm"
        >
          Share on LinkedIn
        </Link>
